...
public class ListDeknatJS extends ListActivity  {
    ...
    public void onCreate(Bundle icicle) {
      ...
      String namagereja[] = {"SP. Maria Ratu"
        		,"Keluarga Kudus"
        		,"St. Yohanes Penginjil"
        		,"St. Fransiskus Asisi"
        		,"St.Stefanus"
        		,"Ratu Rosari Kapel Bahtera Kasih"
        		};
      setContentView(R.layout.listdeknatjs);
	...
	protected void tampilkanPilihan(String pilihan) {
		try {
			...
			Intent i = null;
			if (pilihan.equals("SP. Maria Ratu")) {
				ringkas(pilihan);}
			else if (pilihan.equals("Keluarga Kudus")) {
				ringkas(pilihan);}
			else if (pilihan.equals("St. Yohanes Penginjil")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("St. Fransiskus Asisi")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("St.Stefanus")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("Ratu Rosari Kapel Bahtera Kasih")) {
				ringkas(pilihan);}	
