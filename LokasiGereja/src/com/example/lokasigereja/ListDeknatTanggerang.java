...
public class ListDeknatTanggerang extends ListActivity  {
    ...
    public void onCreate(Bundle icicle) {
      ...
      setContentView(R.layout.listdeknattanggerang);
	...
	protected void tampilkanPilihan(String pilihan) {
		try {
			...
			Intent i = null;
			if (pilihan.equals("St. Bernadet")) {
				ringkas(pilihan);}
			else if (pilihan.equals("St. Matius, Penginjil")) {
				ringkas(pilihan);}
			else if (pilihan.equals("St. Agustinus")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("Rasul Barnabas")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("St. Monika")) {
				ringkas(pilihan);}	
			else if (pilihan.equals("St. Maria")) {
				ringkas(pilihan);}	
